...
export interface IApi {
  ...
  globalNovelFeed(opts?: { offset?: number }): Promise<Paged<Novel[]>>;
  ...
  myLiveFeed(opts?: { offset?: number }): Promise<Paged<Live[]>>;
  ...
  */
  ...
  popularLiveFeeds(opts?: { offset?: number }): Promise<Paged<Live[]>>;
...
export class Api implements IApi {
  ...
  constructor(
    args: { refreshToken: string; accessToken: string; expires: Date },
    d: Domains
  );
  ...
  private login = async (force = false): Promise<string> => {
    ...
    const r = await fetch(this.domains.tokenAuth, {
      method: 'POST',
      headers: headers,
  ...
  myFeed = (
    ...
    return this.apiReq({
      ...
      params: [['restrict', opts.restrict || 'all'], ['offset', opts.offset]],
      unpack,
    });
  };
  ...
  myLiveFeed = (
    ...
    return this.apiReq({
      method: 'GET',
      url: 'v1/live/list',
      params: [['list_type', 'following'], ['offset', opts.offset]],
      unpack,
    });
  };
  ...
  */
  ...
  searchUsers = (
    ...
    return this.apiReq({
      method: 'GET',
      url: 'v1/search/user',
      params: [['word', query], ['offset', opts.offset]],
      unpack,
    });
  };
  ...
  relatedIllusts = (
    ...
    return this.apiReq({
      ...
      params: [['illust_id', startId], ['seed_illust_ids', prev]],
      unpack,
    });
  };
  ...
  popularLiveFeeds = (
    ...
    return this.apiReq({
      method: 'GET',
      url: 'v1/live/list',
      params: [['list_type', 'popular'], ['offset', opts.offset]],
      unpack,
    });
  };
  ...
  trendingTags = (): Promise<Array<[string, Illust]>> => {
    const unpack = (resp: Raw.TrendingTags): Array<[string, Illust]> =>
      resp.trend_tags.map(
        (t): [string, Illust] => [t.tag, To.illust(t.illust)]
      );
  ...
  userNovels = (
    ...
    return this.apiReq({
      method: 'GET',
      url: 'v1/user/illusts',
      params: [['user_id', user], ['type', 'novel'], ['offset', opts.offset]],
      unpack,
    });
  };
  ...
  follow = async (
    ...
    await this.apiReq({
      ...
      params: [['user_id', id], ['restrict', opts.restrict || 'public']],
      unpack: (_) => {},
    });
  };
